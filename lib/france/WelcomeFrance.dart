...
import 'package:travel_app/france/FranceHomeScreen.dart';

import '../shared/components.dart';

class WelcomeEgypt extends StatelessWidget {
  const WelcomeEgypt({Key? key}) : super(key: key);
              ...
              children: [
                Transform.rotate(
                    ...
                    child:IconButton(onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Francehome()));
